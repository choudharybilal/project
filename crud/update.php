...
if(isset($_POST['update'])){
  ...
  $query      = mysqli_query($conn, "UPDATE user SET username = '$username', email = '$email', password = '$password' , cnfpassword = '$cnfpassword' WHERE id = '$id'");
  if ($query) {
  ...
  $cnfpassword = $r['cnfpassword'];
   ?>
    <form method="POST" action="update.php">
        ...
        <div class="form-group">
          <input type="submit" name="update" class="btn btn-info" value="Update Student">
        </div><!-- form-group -->
       </form><!-- form -->
<?php endif; ?>
