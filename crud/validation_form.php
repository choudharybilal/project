...
$nameErr = $emailErr = $genderErr = $websiteErr = $passwordErr = $phoneErr = "";
$name = $email = $gender = $comment = $website = $password = $phone = "";
...
if(!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password) < 8) {
  ...
  if (empty($_POST["phone"])) {
    ...
    // check if phonenumber only contain latters and whitespace
    if (!preg_match("/^[0-9]{4}-[0-9]{7}$/",$phone)) {
      $phoneErr = "Follow this phone number formet 0000-0000000";
    }
  }
