...
if (mysqli_num_rows($results) > 0) {
  $nameErr ="This User Name Already Exist Please Try Another";
}
    // $email = $_POST['email'];
  ...
  if(!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password) < 8) {
    ...
    if ($cnfpassword !== $password) {
      $cnfpasswordErr ="password Not match";
    }
    //  $passwordmd5 = md5 ($password);
    //  $cnfpasswordmd5 = md5 ($cnfpassword);
    ...
    // else
    // {
    //     echo "Error while registration you...";
...
<body>
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="colorlibcopy-agile">
			<p>© 2019 Signup Form. All rights reserved | Design by <a href="https://colorlib.com/" target="_blank">Bilal</a></p>
		</div>
		<!-- //copyright -->
